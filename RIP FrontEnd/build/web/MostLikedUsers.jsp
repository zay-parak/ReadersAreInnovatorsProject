        ...
        <script type="text/javascript">
            ...
            function drawPieChart() {
                <%  
                    ...
                    String name=type==2?"Most view Writer":"Most accepting Editor";
                    RipServiceInterface service=Service.getService();
                          List<User> users = service.getTopUsers(amount,type,Date.valueOf(start),Date.valueOf(end)) ;
                          %>
                var data = google.visualization.arrayToDataTable([['Title','<%= name %>'],
                    ...
                    value=Integer.valueOf(user.getName()); %>
